...
Grafo* Grafo::guloso_rando()
{
    ...
    for (int i = 0; i < iteracoes; i++) {
        ...
        if (conjunto_atual.size() < menor_tamanho) {  // Atualiza a melhor solução encontrada
            ...
            delete resultado_atual; // Descarta solução anterior se a atual for melhor
        }
    }
