...
void Gerenciador::comandos(Grafo* grafo) {
    ...
    switch (resp) {
        ...
        case 'k': {
            float a[5] = {0.05, 0.1, 0.15, 0.3, 0.5};
            for(int n=0; n<5; n++){
                float alpha = a[n];
                Grafo* guloso_rando = grafo->guloso_rando(alpha);
                cout << "grafo guloso randomizado com alpha " << alpha << ": " << endl;
        ...
        case 'l': {
            Grafo* guloso_rando_reativo = grafo->guloso_rando_reativo();
            cout << "grafo guloso randomizado adaptativo reativo:" << endl;
            guloso_rando_reativo->printGrafo();
            delete guloso_rando_reativo;
            break;
        }
