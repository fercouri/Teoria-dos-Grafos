...
int main(int argc, char** argv) 
{
    ...
    do 
    {
        ...
        std::cout << "3. Caminho minimo (Dijkstra)\n";
        std::cout << "4. Caminho minimo (Floyd-Warshall)\n";
        ...
        std::cout << "8. Raio, diametro, centro e periferia\n";
        std::cout << "0. Sair\n";
        std::cout << "Escolha: ";
        std::cin >> opcao;
        ...
        {
            std::cout << "Digite os vertices do subconjunto X (sem espacos, ex: ABCD): ";
            std::string linha;
            std::cin >> linha;
        ...
        else if (opcao == 7) 
        {
            ...
            std::cout << "Arvore de Caminhamento (DFS):\n";
            arvore->printGrafo();
            std::cout << "Salvar resultado? (s/n): ";
            char salvar;
            std::cin >> salvar;
        ...
        {
            std::cout << "Raio: " << g.raio() << std::endl;
            std::cout << "Diametro: " << g.diametro() << std::endl;
            std::cout << "Centro: ";
            exibir_vetor(g.centro());
            std::cout << "Periferia: ";
            exibir_vetor(g.periferia());
        }
    }
